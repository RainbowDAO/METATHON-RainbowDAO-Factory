...
export default {
  ...
  methods: {
    next(index) {
      if(this.tokenInfo.totalSupply>100000){
        alert('totalSupply too lang')
        return
      }
    ...
    createMul() {
      ...
      this.tokenInfo.totalSupply = this.tokenInfo.totalSupply * (10**this.tokenInfo.decimals)

      this.$store.dispatch("daoFactory/creatDaoWithNewToken", {
        ...this.tokenInfo,
        ...this.daoInfo
      }).then(()=>{
        this.$router.push({
